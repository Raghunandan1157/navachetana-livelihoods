...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // The enhanced dashboard in agent-dashboard.js will override this.
    // This is a no-op placeholder that agent-dashboard.js replaces.
    window.initAgentDashboard = window.initAgentDashboard || function(agent) {
